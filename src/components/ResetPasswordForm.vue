<template>
    ...
    <div class="w-full max-w-md space-y-8">
      <div>
        ...
        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Zresetuj hasło</h2>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="resetPassword">
        <div class="-space-y-px rounded-md shadow-sm">
            ...
            <div>
                <label for="email-address" class="sr-only">Twój adres e-mail</label>
                <input
                    id="email-address"
                    type="email"
